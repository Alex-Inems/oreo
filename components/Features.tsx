...
const Features = () => {
    ...
    return (
        <section className="py-32 bg-white text-black">
            <div className="w-full max-w-[95vw] min-[2000px]:max-w-[2400px] min-[3000px]:max-w-[3200px] mx-auto px-8 grid md:grid-cols-4 min-[2500px]:grid-cols-8 gap-12 text-center">
                {features.map((f, i) => (
                    <div key={i} className="flex flex-col items-center gap-6">
                        <div className="text-red-600 text-4xl">{f.icon}</div>
                        <h3 className="text-2xl font-light text-gray-900">{f.title}</h3>
